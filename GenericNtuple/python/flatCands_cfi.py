...
flatJpsiMuMu = cms.EDProducer("FlatCandProducer",
    ...
    variables = cms.PSet(
      ...
      lep1Pt = cms.string("daughter(0).pt()"),
      lep2Pt = cms.string("daughter(1).pt()"),
      lep1Eta = cms.string("daughter(0).eta()"),
      lep2Eta = cms.string("daughter(1).eta()"),
      lep1Phi = cms.string("daughter(0).phi()"),
      lep2Phi = cms.string("daughter(1).phi()"),
    ),
    selections = cms.PSet(),
)
...
flatZMuMu = cms.EDProducer("FlatCandProducer",
    ...
    variables = cms.PSet(
      lep1Pt = cms.string("daughter('muon1').pt()"),
      lep2Pt = cms.string("daughter('muon2').pt()"),
      lep1Eta = cms.string("daughter('muon1').eta()"),
      lep2Eta = cms.string("daughter('muon2').eta()"),
      lep1Phi = cms.string("daughter('muon1').phi()"),
      lep2Phi = cms.string("daughter('muon2').phi()"),
    ),
    selections = cms.PSet(),
)
flatZElEl = cms.EDProducer("FlatCandProducer",
    ...
    variables = cms.PSet(
      lep1Pt = cms.string("daughter('electron1').pt()"),
      lep2Pt = cms.string("daughter('electron2').pt()"),
      lep1Eta = cms.string("daughter('electron1').eta()"),
      lep2Eta = cms.string("daughter('electron2').eta()"),
      lep1Phi = cms.string("daughter('electron1').phi()"),
      lep2Phi = cms.string("daughter('electron2').phi()"),
    ),
    selections = cms.PSet(),
)
