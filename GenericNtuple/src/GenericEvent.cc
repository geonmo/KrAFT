...
void GenericEvent::setBranch(TTree* tree)
{
  ...
  tree_->SetBranchAddress("jpsis_id1", &jpsis_id1_);
  ...
  tree_->SetBranchAddress("jpsis_id2", &jpsis_id2_);
